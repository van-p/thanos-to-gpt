/**
 * TestRail API binding for Java (API v2, available since TestRail 3.0) Updated for TestRail 5.7 Learn more: http://docs.gurock.com/testrail-api2/start http://docs.gurock.com/testrail-api2/accessing Copyright Gurock Software GmbH. See license.md for details.
 */
...
public class TestRailClient
{
    ...
    private Object sendRequest(String method, String uri, Object data) throws Exception
    {
        ...
        if (status != 200)
        {
            ...
            if (result != null && result instanceof JSONObject obj)
            {
